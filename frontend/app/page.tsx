          ...
          <motion.div initial="hidden" animate="visible" variants={containerVariants}>
            ...
            <motion.div variants={itemVariants}>
              ...
              <div className="inline-block px-4 py-2 rounded-full border border-cyan-500/50 bg-cyan-500/10 backdrop-blur-sm mb-6">
                <span className="text-cyan-400 font-mono text-sm">✨ TechXelarate 2026</span>
              </div>
              </div>
            </motion.div>
            ...
            <motion.div variants={itemVariants}>
              ...
              <p className="text-lg sm:text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed">
                Compete across 23 diverse domains spanning AI, sustainability, healthcare, green tech, education, and more. Build tomorrow's solutions today.
              </p>
              </div>
            </motion.div>
    ...
    >
      Contact
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">Email: lbrcehackcsm@gmail.com</p>
                <p className="text-gray-400 text-sm">Phone: +91-7036636671</p>
              </div>
              <div>
